...
# Predefined password (you can change it as needed)
correct_password = "Jig321?"
...
if password == correct_password:
    st.success("Password accepted! Loading the application...")
    ...
    # If the password is not entered or incorrect, show an error message
    if password != "":
